	...
	<body>
		<div id="form-wraper">
			<form action="cadastrarMedico.php" method="POST">
				...
				<div class="form-group">
					<label>Nome:</label>
					<input type="text" id="nome" name="nome" placeholder="Ex: Maria Silva" value=<?php if(isset($_GET['id'])) echo "'" . $medico[0]['nome'] . "'" ;?>/>				
				</div>

				<div class="form-group">
					<label>Email:</label>
					<input type="text" id="email" name="email" placeholder="Ex: maria.silva@gmail.com" value=<?php if(isset($_GET['id'])) echo "'" . $medico[0]['email'] . "'" ;?>/>				
				</div>

				<div class="form-group">
					<label>Celular:</label>
					<input type="text" class="celular" id="celular" name="celular" placeholder="(99)9999-9999" value=<?php if(isset($_GET['id'])) echo "'" . $medico[0]['celular'] . "'" ;?>/>				
				</div>

				<div class="form-group">
					<label>Telefone:</label>
					<input type="text" class="telefone" id="telefone" name="telefone" placeholder="Ex: (51)9999-9999" value=<?php if(isset($_GET['id'])) echo "'" . $medico[0]['telefone'] . "'" ;?>/>/>				
				</div>			
